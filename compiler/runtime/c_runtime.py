    ...
    def header_source(self) -> str:
        return "\n".join(
            [
                ...
                "const char *py_str_slice(const char *value, int start, int end, int has_start, int has_end);",
    ...
    def implementation_source(self) -> str:
        return "\n".join(
            [
                ...
                '    const char *str = value ? value : "";',
                "    size_t len = strlen(str);",
                "    int s = has_start ? start : 0;",
                "    int e = has_end ? end : (int)len;",
                "    if (s < 0) s = (int)len + s;",
                "    if (e < 0) e = (int)len + e;",
                "    if (s < 0) s = 0;",
                "    if (e < 0) e = 0;",
