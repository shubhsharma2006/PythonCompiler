# Graph Report - compiler project  (2026-06-03)

## Corpus Check
- 135 files · ~97,259 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1887 nodes · 4369 edges · 151 communities (115 shown, 36 thin omitted)
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 1624 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7df4c6fe`
...
1. `PipelineTests` - 115 edges
2. `ValueType` - 103 edges
...
8. `CFGLowering` - 69 edges
9. `compile_source()` - 67 edges
10. `ExprParser` - 63 edges

## Surprising Connections (you probably didn't know these)
- `main()` --calls--> `py_incref()`  [INFERRED]
  output_try_finally.c → py_runtime.c
- `main()` --calls--> `py_decref()`  [INFERRED]
  output_try_finally.c → py_runtime.c
- `main()` --calls--> `py_error_occurred()`  [INFERRED]
  output_try_finally.c → py_runtime.c
- `main()` --calls--> `py_set_error()`  [INFERRED]
  output_try_finally.c → py_runtime.c
...
Cohesion: 0.06
Nodes (23): iter_curated_cases(), DifferentialProgramGenerator, build_parser(), main(), CaseResult, ExecutionOutcome, MismatchBundle, ParitySummary (+15 more)
...
Cohesion: 0.08
Nodes (24): rebuild_edges(), build_use_def_map(), _collect_constants(), _current_name(), _defined_name(), _definition_sites(), dominance_frontiers(), _fold_binary() (+16 more)
...
Cohesion: 0.07
Nodes (22): _analyze_source(), check_source(), compile_source(), _load_bytecode_module(), _program_uses_call_kwargs_splats(), _program_uses_call_signature_features(), _program_uses_compare_chains(), _program_uses_container_features() (+14 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (27): compile_source(), _contains_node(), _has_call_kwargs(), _is_float_literal(), _is_int_literal(), _negative_int_expr(), _program_uses_call_kwargs_splats(), _program_uses_call_signature_features() (+19 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (12): _build_type_map(), CCodeGenerator, _default_initializer(), _literal(), Generate a C function call., Generate a C function call., Generate a C function call., c_type_name() (+4 more)
...
Cohesion: 0.08
Nodes (12): py_gc_collect(), py_gc_count(), py_register_type(), py_runtime_init(), py_tuple_check_index(), py_tuple_get_bool(), py_tuple_get_float(), py_tuple_get_int() (+4 more)
...
Cohesion: 0.17
Nodes (11): block_map(), compute_dominators(), compute_post_dominators(), immediate_post_dominators(), reachable_block_names(), reverse_post_order(), _collect_uses(), _common_postdom() (+3 more)
...
Cohesion: 0.11
Nodes (19): code:block33 (┌───────────────────────────────────────────────────────────), code:block34 (┌───────────────────────────────────────────────────────────), code:python (@dataclass), From the Debugger Protocol, From the Visualization Design, How Each Feature from Both Ideas Maps to the Unified System, One-Line Summary of the Combined Vision, Revised Final Priority Order (Unified) (+11 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (17): gc_register(), py_float_to_str(), py_floor_div_int(), py_int_to_str(), py_list_check_type(), py_list_len(), py_malloc(), py_malloc_site() (+9 more)
...
Cohesion: 0.2
Nodes (15): add(), greet(), main(), square(), gc_unregister(), py_decref(), py_header(), py_incref() (+7 more)
...
Cohesion: 0.13
Nodes (14): **AI-Grade Compiler Potential: Massive — unique opportunity**, code:block1 (Source Code (.py)), 📊 Completion % Per Module, 📐 Full Pipeline at a Glance, 🐛 Known Bugs & Issues, 🟡 Medium Bugs, Overall: **~88% complete** for the defined VM-first Python subset, **Overall Production Grade: 73% / 100** (+6 more)
...
Cohesion: 0.14
Nodes (14): 3D Specific, Backend / Server, code:block1 (Source Code (text string)), Core Visualization, 🚧 Drawbacks & Limitations, 📁 Files to Create, 🏁 Implementation Roadmap, 🔬 Live Compiler Visualization — Full Design Spec (+6 more)
...
Cohesion: 0.15
Nodes (13): 2D Design, 2D Design, 2D Design, 2D Design, 3D Design, code:block5 (B0: x = 10         B1: x = 20), code:block6 (B0: x.0 = 10      B1: x.1 = 20), code:block7 (x.0 ──────┐) (+5 more)
...
Cohesion: 0.21
Nodes (6): build_parser(), _emit_dump(), main(), _maybe_emit_ast_viz(), execute_source(), _module_name_for_filename()

### Community 44 - "Community 44"
Cohesion: 0.36
Nodes (11): _container_elem_type_for_expr(), _program_uses_len_with_non_string(), _program_uses_tuple_index_assign(), _program_uses_unsupported_container_compare_membership(), _program_uses_unsupported_container_display(), _program_uses_unsupported_container_literals(), _program_uses_unsupported_index_assign(), _program_uses_unsupported_indexing() (+3 more)
...
Cohesion: 0.22
Nodes (7): main(), main(), py_clear_error(), py_error_occurred(), py_truthy_int(), py_write_int(), py_write_str()
...
Cohesion: 0.25
Nodes (8): py_list_check_index(), py_list_get_bool(), py_list_get_float(), py_list_get_int(), py_list_get_str(), py_list_set_bool(), py_list_set_float(), py_list_set_int()
...
Cohesion: 0.4
Nodes (5): py_tuple_alloc(), py_tuple_new_bool(), py_tuple_new_float(), py_tuple_new_int(), py_tuple_new_str()

### Community 71 - "Community 71"
Cohesion: 0.4
Nodes (5): py_list_alloc(), py_list_new_bool(), py_list_new_float(), py_list_new_int(), py_list_new_str()
...
Cohesion: 0.67
Nodes (3): 2D Design, Phase 5 — AST Optimization (Constant Folding), What You See Fold

## Knowledge Gaps
- **427 isolated node(s):** `Legacy compatibility module.  The active semantic implementation lives in `compi`, `Legacy compatibility module.  The active IR implementation lives in `compiler.ir`, `Legacy compatibility module.  The active parser stage lives in `compiler.fronten`, `Legacy compatibility module.  The compiler now parses Python source via the stdl`, `Legacy compatibility module.  The active optimizer lives in `compiler.optimizer`` (+422 more)
...
- **Why does `ValueType` connect `Community 0` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 45`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `compile_source()` connect `Community 9` to `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 10`, `Community 43`, `Community 44`, `Community 45`, `Community 13`, `Community 15`, `Community 24`, `Community 29`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `BytecodeLowerer` connect `Community 0` to `Community 1`, `Community 8`, `Community 43`, `Community 26`, `Community 29`?**
